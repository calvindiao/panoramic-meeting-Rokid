...
namespace Rokid.UXR.Demo
{
    ...
    public class DragMe : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        public static bool ScreenPointToWorldPointInRectangle(RectTransform rect, out Vector3 worldPoint)
        {
            worldPoint = Vector2.zero;

            Ray ray = RayManager.CurrentRay.Ray;// ScreenPointToRay(cam, screenPoint);
